// mp.events.add('spectate', (player, getId) => { 
//     //let spectate = mp.cameras.new('spectator', new mp.Vector3(getId.position), new mp.Vector3(getId.rotation), 40);
//     let spectate = mp.cameras.new('spectator')
//     //spectate.attachTo(getId.handle, getId.getBoneIndex(31086), 5.0, 1.0, true);
//     spectate.setActive(true);
//     spectate.attachTo(getId.handle, 1.0, -1.0, 0.0, true)
//     mp.game.cam.renderScriptCams(true, false, 0, true, false);
// });
// mp.events.add('unspectate', (player) => { 
...
mp.events.add('client:freecam', (player) => {
  isNoClip = !isNoClip;
